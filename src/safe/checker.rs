use crate::safe::types::{UnsafetyCheckResult, UnsafetyViolation};

/// Borrowed from https://github.com/rust-lang/rust/blob/7c2d57e0fa1615d993a4b4166163fb0b3ec7d395/compiler/rustc_mir_transform/src/check_unsafety.rs#L1-L627 and reworked to work for this crate
use super::types;
...
use rustc_middle::mir::{UnsafetyViolationDetails, UnsafetyViolationKind};
use rustc_middle::ty::query::Providers;
use rustc_middle::ty::{self, TyCtxt};
use rustc_middle::{
    lint,
    mir::{
        AggregateKind, Body, LocalInfo, Location, Place, ProjectionElem, Rvalue, Safety,
        SourceInfo, Statement, StatementKind, Terminator, TerminatorKind, UnusedUnsafe,
        UsedUnsafeBlockData,
    },
};
        ...
        match safety {
            ...
            Safety::Safe => violations.into_iter().for_each(|&violation| {
                match violation.kind {
                    ...
                    UnsafetyViolationKind::UnsafeFn => {
                        panic!("`UnsafetyViolationKind::UnsafeFn` in an `Safe` context")
                    }
                }
            ...
            Safety::ExplicitUnsafe(hir_id) => violations.into_iter().for_each(|violation| {
                update_entry(
                    ...
                    match self
                        .tcx
                        .lint_level_at_node(UNSAFE_OP_IN_UNSAFE_FN, violation.lint_root)
                        .0
                    {
...
fn check_unused_unsafe(
    ...
    let Some(body_id) = body_id else {
        tracing::debug!("check_unused_unsafe({:?}) - no body found", def_id);
        return vec![];
    };
...
fn unsafety_check_result<'tcx>(
    ...
    tracing::debug!("unsafety_violations({:?})", def);
...
pub fn check_unsafety(tcx: TyCtxt<'_>, def_id: LocalDefId) {
    tracing::debug!("check_unsafety({:?})", def_id);
